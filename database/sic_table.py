...
class SicTableCreator:
    ...
    def insert_sic_codes(self, sic_data: dict[int, tuple[str, str]]):
        ...
        """
        self.logger.info(f"Inserting {len(sic_data)} SIC codes into the lookup table.")
...
if __name__ == "__main__":
    ...
    sic_creator = SicTableCreator(db_connection)
    sic_creator.create_sic_table()
    sic_data = {
        ...
        2820: ("Industrial Applications and Services", "PLASTIC MATERIAL, SYNTH RESIN/RUBBER, CELLULOS (NO GLASS)"),
        ...
        7990: ("Office of Trade & Services", "SERVICES-MISCELLANEOUS AMUSEMENT & RECREATION SERVICES"),
    ...
    sic_creator.insert_sic_codes(sic_data)
    result = db_connection.execute("FROM sic_codes").pl()
    print(result.head())
